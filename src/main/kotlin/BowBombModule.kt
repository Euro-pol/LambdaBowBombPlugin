...
internal object BowBombModule : PluginModule(
    ...
    private val spoofs by setting("Spoofs", 1, 1..100, 10)
    ...
    init {
        safeListener<PacketEvent.Send> {
            ...
            if ((it.packet as CPacketPlayerDigging).action == CPacketPlayerDigging.Action.RELEASE_USE_ITEM  && (mc.player.getHeldItem(EnumHand.MAIN_HAND).item == Items.BOW || mc.player.getHeldItem(EnumHand.OFF_HAND).item == Items.BOW) || mc.player.getHeldItem(EnumHand.MAIN_HAND).item == Items.SNOWBALL && others || mc.player.getHeldItem(EnumHand.OFF_HAND).item == Items.SNOWBALL && others || mc.player.getHeldItem(EnumHand.MAIN_HAND).item == Items.ENDER_PEARL && others || mc.player.getHeldItem(EnumHand.OFF_HAND).item == Items.ENDER_PEARL && others || mc.player.getHeldItem(EnumHand.MAIN_HAND).item == Items.EGG && others || mc.player.getHeldItem(EnumHand.OFF_HAND).item == Items.EGG && others) {
        ...
        bind.value.setBind(Keyboard.KEY_G)
    }
}